...
.btn{
	...
	outline: none;
	border: none;
	background-image: linear-gradient(to right, #f84d4c, #cb519f);
	background-size: 200%;
	font-size: 1.2rem;
	color: #fff;
	font-family: 'Poppins', sans-serif;
			  ...
			  <form runat="server">
				...
				<h2 class="title">تسجيل الدخول</h2>
           		...
           		<div class="input-div pass">
                     ...
                     <asp:TextBox ID="password" TextMode="Password" Class="input" runat="server"></asp:TextBox>
            	   </div>
            	</div>
            	<!--<a href="#">Forgot Password?</a>-->
            	<%--<input type="submit" class="btn" value="تسجيل الدخول">--%>
                <asp:Button ID="btnlog" runat="server" class="btn" Text="تسجيل الدخول" OnClick="btnlog_Click" />
